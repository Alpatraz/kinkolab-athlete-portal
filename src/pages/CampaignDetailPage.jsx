...
export default function CampaignDetailPage({ campaign, athletes, goBack, onOpenAthlete, openSignup }) {
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <section className="rounded-[2rem] border border-zinc-800 bg-zinc-950 p-6 md:p-10">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <a href={campaign.shopifyCollectionUrl} className="inline-flex items-center gap-2 rounded-2xl px-5 py-3 font-black text-black" style={{ background: gold }}>
              <ShoppingBag size={18} /> Voir la collection Shopify
            </a>

            <button onClick={openSignup} className="inline-flex items-center gap-2 rounded-2xl border border-zinc-700 px-5 py-3 font-black text-white hover:bg-zinc-900">
