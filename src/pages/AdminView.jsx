...
export default function AdminView({
  ...
  async function wiseAction(action, campaignId = "") {
    ...
    try {
      ...
      alert(action === "sync" ? "Les statuts Wise ont été synchronisés." : action === "setup_webhook" ? "Le webhook Wise a été enregistré." : action === "retry_funding" ? "La demande de financement a été soumise à Wise. Vérifiez maintenant la file d’approbation Wise." : "Les campagnes admissibles ont été préparées et soumises à Wise. L’approbation finale demeure obligatoire dans Wise.");
