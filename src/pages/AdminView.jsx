      ...
      <div className="mx-auto max-w-7xl">
        ...
        <section className="rounded-[2rem] bg-white p-6 shadow-xl md:p-10">
          ...
          <p className="mt-4 max-w-3xl text-lg leading-8 text-zinc-600">
            Gestion des candidatures, athlètes, familles, campagnes,
        ...
        {acceptedAccess && (
          <section className="mt-8 rounded-[2rem] border border-emerald-300 bg-emerald-50 p-6 shadow-xl">
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              ...
              <AdminButton
                variant="light"
                onClick={() => onOpenAthlete(acceptedAccess.athleteId)}
              >
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-between gap-4 md:flex-row md:items-start">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-zinc-600">
                          Objectif : {money(Number(application.desiredGoal || 0))}
                        </p>
                      </div>
                    ...
                    <div className="mt-5 grid gap-2 text-sm text-zinc-700 md:grid-cols-2">
                      <p>
                        <b>Courriel athlète :</b> {application.email}
                      </p>
                      <p>
                        <b>Parent :</b> {application.parentName}
                      </p>
                      <p>
                        <b>Courriel parent :</b> {application.parentEmail}
                      </p>
                      <p>
                        <b>Téléphone parent :</b> {application.parentPhone}
                      </p>
                      <p>
                        <b>Coach :</b> {application.coach}
                      </p>
                      <p>
                        <b>Discipline :</b> {application.discipline}
                      </p>
                      <p>
                        <b>Ceinture :</b> {application.belt}
                      </p>
                      <p>
                        <b>Famille :</b> {application.familyName}
                      </p>
                    </div>
              ...
              {athletes.map((athlete) => (
                ...
                >
                  <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
                    <div>
                      ...
                      <p className="text-sm text-zinc-500">
                        {athlete.dojo} ·{" "}
                        {campaignTitle(allCampaigns, athlete.campaignId)}
                      </p>
                      <div className="mt-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <AdminButton
                        variant="amber"
                        onClick={() => updateAthleteStatus(athlete, "suspendu")}
                      >
                        <Ban size={16} /> Suspendre
                      </AdminButton>
                      <AdminButton
                        variant="green"
                        onClick={() => updateAthleteStatus(athlete, "actif")}
                      >
                        <RotateCcw size={16} /> Réactiver
                      </AdminButton>
                      <AdminButton
                        variant="light"
                        onClick={() => updateAthleteStatus(athlete, "archivé")}
                      >
                  ...
                  <div className="mt-3 text-sm text-zinc-600">
                    Progression : <b>{progressOf(athlete)}%</b> · Objectif :{" "}
                    <b>{money(athlete.goal || 0)}</b>
                  </div>
                </div>
              ))}
            </div>
        ...
        {activeTab === "families" && (
          <section className="mt-8 grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
            <div className="rounded-[2rem] bg-white p-6 shadow-xl">
              ...
              <div className="mt-5 grid gap-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewFamily({ ...newFamily, contactName: e.target.value })
                  }
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewFamily({ ...newFamily, contactEmail: e.target.value })
                  }
            ...
            <div className="rounded-[2rem] bg-white p-6 shadow-xl">
              ...
              <div className="mt-5 space-y-4">
                {families.length === 0 && (
                  <p className="text-zinc-500">Aucune famille créée.</p>
                )}
                    ...
                    >
                      <div className="flex flex-wrap items-start justify-between gap-4">
                        <div>
                          ...
                          <p className="text-sm text-zinc-500">
                            {family.contactName || "Responsable non défini"}
                          </p>
                          <p className="text-sm text-zinc-500">
                            {family.contactEmail}
                          </p>
                      ...
                      <div className="mt-5 space-y-2">
                        <p className="text-sm font-black text-zinc-700">
                          Athlètes de la famille
                        </p>
                        {familyAthletes.length === 0 && (
                          <p className="text-sm text-zinc-400">
                            Aucun athlète rattaché.
                          </p>
                        )}
                        ...
                        {familyAthletes.map((athlete) => (
                          ...
                          >
                            ...
                            <AdminButton
                              variant="red"
                              onClick={() => removeAthleteFromFamily(athlete, family)}
                            >
                      ...
                      <div className="mt-5 space-y-2">
                        <p className="text-sm font-black text-zinc-700">
                          Ajouter un athlète sans famille
                        </p>
            ...
            <div className="rounded-[2rem] bg-white p-6 shadow-xl">
              ...
              <div className="mt-5 grid gap-3">
                <input
                  ...
                  onChange={(event) =>
                    setNewCampaign({ ...newCampaign, title: event.target.value })
                  }
                  placeholder="Titre"
                  className="rounded-2xl border border-zinc-200 p-3"
                />
                <input
                  ...
                  onChange={(event) =>
                    setNewCampaign({ ...newCampaign, year: event.target.value })
                  }
                  placeholder="Année"
                  className="rounded-2xl border border-zinc-200 p-3"
                />
                <input
                  ...
                  onChange={(event) =>
                    setNewCampaign({ ...newCampaign, country: event.target.value })
                  }
                  placeholder="Pays"
                  className="rounded-2xl border border-zinc-200 p-3"
                />
                <input
                  ...
                  onChange={(event) =>
                    setNewCampaign({ ...newCampaign, city: event.target.value })
                  }
                  placeholder="Ville"
                  className="rounded-2xl border border-zinc-200 p-3"
                />
                ...
                <input
                  ...
                  onChange={(event) =>
                    setNewCampaign({ ...newCampaign, goal: event.target.value })
                  }
                  type="number"
                ...
                <input
                  ...
                  onChange={(event) =>
                    setNewCampaign({
                      ...newCampaign,
                      sponsorUrl: event.target.value,
                    })
                  }
                  placeholder="Lien commandite"
                  className="rounded-2xl border border-zinc-200 p-3"
                />
                <textarea
                  ...
                  >
                    {editingCampaignId === campaign.id ? (
                      <div className="grid gap-3">
                        ...
                        <input
                          type="date"
                          value={editingCampaign.eventDate}
                          onChange={(event) =>
                            setEditingCampaign({
                              ...editingCampaign,
                              eventDate: event.target.value,
                        ...
                        />
                        <input
                          value={editingCampaign.shopifyUrl}
                          onChange={(event) =>
                            setEditingCampaign({
                              ...editingCampaign,
                              shopifyUrl: event.target.value,
                      ...
                      <>
                        ...
                        <p className="mt-1 text-sm text-zinc-600">
                          {campaign.year || ""} · {campaign.city || ""}{" "}
                          {campaign.country || ""} · Objectif :{" "}
                          {money(Number(campaign.goal || 0))}
                        </p>
                        <p className="mt-1 text-sm text-zinc-600">
                          Début : {campaign.startDate || "—"} · Fin :{" "}
                        ...
                        <div className="mt-3 flex flex-wrap items-center gap-2">
                          ...
                          <AdminButton
                            variant="amber"
                            onClick={() =>
                              updateCampaignStatus(campaign, "suspendue")
                            }
                          >
                            Suspendre
                          </AdminButton>
                          <AdminButton
                            variant="light"
                            onClick={() =>
                              updateCampaignStatus(campaign, "terminee")
                            }
                          >
                            Terminée
                          </AdminButton>
                          <AdminButton
                            variant="light"
                            onClick={() =>
                              updateCampaignStatus(campaign, "archivée")
                            }
                          >
                            Archiver
                          </AdminButton>
              ...
              <div className="mt-5 grid gap-3">
                ...
                <select
                  ...
                  onChange={(event) =>
                    setNewParticipation({
                      ...newParticipation,
                      fundingMode: event.target.value,
                    })
                  }
                  className="rounded-2xl border border-zinc-200 p-3"
                >
                ...
                {participations.map((participation) => (
                  ...
                  >
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      <AdminButton
                        variant="green"
                        onClick={() => updateParticipationStatus(participation, "active")}
                      >
                        Active
                      </AdminButton>
                      ...
                      <AdminButton
                        variant="amber"
                        onClick={() =>
                          updateParticipationStatus(participation, "suspendue")
                        }
                      >
                        Suspendre
                      </AdminButton>
                      ...
                      <AdminButton
                        variant="light"
                        onClick={() =>
                          updateParticipationStatus(participation, "terminee")
                        }
                      >
                        Terminée
                      </AdminButton>
                      ...
                      <AdminButton
                        variant="light"
                        onClick={() =>
                          updateParticipationStatus(participation, "archivée")
                        }
                      >
                        Archiver
                      </AdminButton>
