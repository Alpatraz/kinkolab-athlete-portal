...
const copy = {
  fr: {
    ...
    sections: [
      ["1. Renseignements collectés", ["Identité et contact : nom, prénom, courriel, adresses de livraison et de facturation et téléphone.", "Données de paiement des achats : elles sont traitées de façon sécurisée par Shopify et ses fournisseurs. KinkoLab ne conserve jamais vos numéros de carte.", "Renseignements de versement des athlètes : nom légal, qualité du bénéficiaire, méthode choisie et, pour Interac, adresse courriel de réception. Les numéros bancaires bruts ne sont pas enregistrés directement dans Firebase.", "Données de navigation : adresse IP, type de navigateur et témoins de session nécessaires au fonctionnement et à l’amélioration du site."]],
      ...
      ["3. Partage et conservation", ["Nous ne vendons ni ne louons vos données. Elles sont partagées uniquement avec les fournisseurs nécessaires au service, notamment Shopify, les fournisseurs de paiement et les services de livraison, et conservées seulement pendant la durée requise par nos obligations légales et opérationnelles.", "Avant d’utiliser un fournisseur de dépôt direct ou de communiquer des renseignements financiers hors Québec, KinkoLab doit évaluer les facteurs relatifs à la vie privée et encadrer la communication par une entente appropriée."]],
  ...
  en: {
    ...
    sections: [
      ["1. Information we collect", ["Identity and contact information: name, email, shipping and billing addresses, and phone number.", "Purchase payment information is securely processed by Shopify and its providers. KinkoLab never stores your card numbers.", "Athlete payout information: legal name, beneficiary capacity, selected method and, for Interac, the receiving email address. Raw bank account numbers are not stored directly in Firebase.", "Browsing data: IP address, browser type and session cookies required to operate and improve the website."]],
      ...
      ["3. Sharing and retention", ["We do not sell or rent your data. It is shared only with service providers required to deliver the service, including Shopify, payment providers and shipping providers, and retained only as long as required for legal and operational purposes.", "Before using a direct-deposit provider or communicating financial information outside Quebec, KinkoLab must conduct a privacy impact assessment and govern the communication through an appropriate agreement."]],
