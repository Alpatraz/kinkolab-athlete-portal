  ...
  return (
    <main className="min-h-screen bg-black p-4 text-white md:p-8">
      <div className="mx-auto max-w-6xl">
            ...
            <div>
              ...
              <div className="mt-8 rounded-2xl border border-amber-500/30 bg-amber-500/10 p-4">
                ...
                >
                  ...
                  {safeAthlete.name || "cet athlète"} comme athlète
                  supporté.
                </p>
              </div>
        ...
        <section className="mt-8 rounded-[2rem] bg-zinc-950 p-6">
          <SectionTitle icon={Megaphone} title={`Dernières nouvelles de ${firstName}`} />
        ...
        <section className="mt-8 rounded-[2rem] bg-zinc-950 p-6">
          <SectionTitle icon={HeartHandshake} title={`Partenaires de ${firstName}`} />
